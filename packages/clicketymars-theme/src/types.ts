 ...
 */
interface clicketymarsTheme extends Package {
  /**
  ...
  actions: {
    ...
    theme: {
       ...
       */
      toggleMobileMenu: Action<clicketymarsTheme>;

      /**
       * Closes the mobile menu, not matter the previous state.
       */
      closeMobileMenu: Action<clicketymarsTheme>;
    };
  };
...
export default clicketymarsTheme;
